var utils = require('../node_modules/rest-js/lib/utils');
var RestRequest = require('../node_modules/rest-js/lib/rest_request');
var processErrors = require('./utils.js').processErrors;
	...
	function onRequestFilters(err) {
		...
		function onResponse(response) {
			...
			function finalize() {
				...
				if (response.error) {
					var processedErrors = processErrors(response.data);
